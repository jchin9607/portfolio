    ...
    const observer = new IntersectionObserver((entries)=>{
        entries.forEach((entry)=>{
            if (entry.isIntersecting) {
                if (currentHeader) currentHeader.classList.add("not-focused");
...
observerz.observe(document.querySelector(".graaay")); // observerz.observe(document.getElementById('projects'));
